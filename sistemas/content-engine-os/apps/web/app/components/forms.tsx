...
export function QuickSourceForm() {
  ...
  return (
    <form className="formCard" onSubmit={onSubmit}>
      ...
      {showAdd ? (
        <div style={{ display: 'grid', gap: 6, border: '1px solid rgba(212,168,60,.3)', borderRadius: 10, padding: 10 }}>
