...
> ⚠️ **Fase 0 (Reset) foi removida em 2026-04-23 a pedido do Tiaro.**
> Este cérebro é um ambiente de produção do **Instituto Vital Slim** — nunca aplicar reset/limpeza de dados aqui. Se precisar de um cérebro novo do zero, crie outro repositório a partir do template oficial.
