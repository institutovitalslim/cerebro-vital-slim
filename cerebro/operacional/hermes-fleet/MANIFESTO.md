...
- hermes-gateway-jarvis.service active/running
- hermes-gateway-joao.service active/running
- hermes-gateway-pedro.service active/running
...
*/15 * * * * export GOG_ACCOUNT=institutovitalslim@gmail.com GOG_KEYRING_PASSWORD=*** && /usr/bin/python3 /root/.openclaw/workspace/ops/zapi_bridge/sync_bridge_patient_exclusions.py >/root/.openclaw/workspace/ops/zapi_bridge/sync_bridge_patient_exclusions.log 2>&1
...
5 3 * * * /root/.openclaw/workspace/ops/zapi_bridge/run_daily_clara_analysis.sh
