#!/bin/bash
# Gerar todos os slides do carrossel GLP-1 + Câncer Endometrial

cd /root/cerebro-vital-slim/deliverables/glp1-cancer-endometrial

# Criar diretório de saída
mkdir -p output_final

# Gerar slides 3-10 via make_tweet_slides.py customizado (fundo branco)
python3 << 'PYTHON_EOF'
import sys
...
# Cores customizadas (fundo branco, texto preto)
WHITE = (255, 255, 255)
BLACK = (0, 0, 0)
DARK_TEXT = (30, 30, 30)
GRAY = (100, 100, 100)
...
avatar = make_circular_avatar('/root/.openclaw/media/inbound/avatar_dradaniely_oficial.png', AVATAR_SIZE)
...
# Slides 3-10 (sem a capa e sem o slide 2 que tem PubMed)
slides_data = [
  {
    "num": 3,
    "paragraphs": [
      "A progestina é o tratamento padrão para proteger o útero. Mas em pacientes com obesidade, o tumor simplesmente não ouve o medicamento."
    ]
  },
  {
    "num": 4,
    "paragraphs": [
      "O que descobriram: os remédios da classe GLP-1 fazem duas coisas ao mesmo tempo. Emagrecem E aumentam os receptores de progesterona no tumor."
    ]
  },
  {
    "num": 5,
    "paragraphs": [
      "É como se o GLP-1 ressuscitasse os receptores que a obesidade tinha silenciado. Aí a progestina consegue se ligar e eliminar a célula cancerígena."
    ]
  },
  {
    "num": 6,
    "paragraphs": [
      "Os números são impressionantes. Estudo com 165 milhões de pacientes mostrou:",
      "",
  ...
  },
  {
    "num": 9,
    "paragraphs": [
      "Cada organismo é único. Seu metabolismo, seus hormônios, sua história.",
      "",
...
for slide in slides_data:
    out_path = f"/root/cerebro-vital-slim/deliverables/glp1-cancer-endometrial/output_final/slide_{slide['num']:02d}.png"
    make_slide_custom(
...
print("\nSlides 3-10 gerados com sucesso!")
PYTHON_EOF

echo "---"
echo "Copiando capa e slide 2..."
cp /root/cerebro-vital-slim/deliverables/glp1-cancer-endometrial/capa.jpg /root/cerebro-vital-slim/deliverables/glp1-cancer-endometrial/output_final/slide_01.jpg
cp /root/cerebro-vital-slim/deliverables/glp1-cancer-endometrial/pubmed.png /root/cerebro-vital-slim/deliverables/glp1-cancer-endometrial/output_final/slide_02.png

echo "Verificando arquivos gerados:"
ls -la /root/cerebro-vital-slim/deliverables/glp1-cancer-endometrial/output_final/
