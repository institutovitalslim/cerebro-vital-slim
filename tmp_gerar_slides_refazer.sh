#!/bin/bash
# Gerar slides 3-10 na pasta refazer

cd /root/cerebro-vital-slim/deliverables/glp1-cancer-endometrial/refazer
...
for slide in slides_data:
    out_path = f"/root/cerebro-vital-slim/deliverables/glp1-cancer-endometrial/refazer/slide_{slide['num']:02d}.png"
