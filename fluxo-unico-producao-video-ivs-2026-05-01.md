...
## Próximos encaixes recomendados
1. transformar este fluxo em arquivo canônico dentro de marketing
2. criar checklist curto de produção diária
3. mapear ativos de vídeo já existentes por tipo
4. integrar ativos úteis ao playbook da Clara
